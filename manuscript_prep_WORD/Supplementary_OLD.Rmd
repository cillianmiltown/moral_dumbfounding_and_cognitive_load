---
title             : "Cognitive Load and Moral Dumbfounding: Supplementary Materials"
...
```{r load_libraries_cogload, include=FALSE, echo=FALSE}
rm(list = ls())
library(citr)
...
```{r S1change,results = 'asis', include=TRUE}
...
```{r S1fig2criticalcondition, fig.cap="Study 1: Responses to critical slide and for the experimental group (*N* = 33) and the control group (*N* = 33)", include=FALSE}
...
```{r S1tab1dumb,results = 'asis', include=FALSE}
...
```{r ggplotlogit1, fig.cap="Study 1: Probability of selecting each response to the critical slide depending on Need for Cognition", include=TRUE}
...
```{r S6change,results = 'asis', include=TRUE}
...
```{r S6ch5S6fig2criticalconditionbIncest, fig.cap="Study 6: Responses to critical slide depending on cognitive load (Julie and Mark)", include=TRUE}
...
```{r S6ch5S6fig2criticalconditionbJennifer, fig.cap="Study 6: Responses to critical slide depending on cognitive load (Jennifer)", include=TRUE}
...
```{r S6ch5S6fig2criticalconditionbTrolley, fig.cap="Study 6: Responses to critical slide depending on cognitive load (Trolley)", include=TRUE}
...
```{r S6ch5S6fig2criticalconditionbHeinz, fig.cap="Study 6: Responses to critical slide depending on cognitive load (Heinz)", include=TRUE}
