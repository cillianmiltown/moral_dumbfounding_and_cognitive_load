...
# read the data file
df_six <- read_csv("../data/study6/sample_data_UK.csv")
...
save(study_6, study6, file = "loaded_data/six_UK.RData")
write.csv(study_6, "csv_files/study_6_UK.csv", row.names = FALSE)
write.csv(study6, "csv_files/study6_UK.csv", row.names = FALSE)
