...
```{r figS1fig2criticalcondition, fig.cap="Study 1: Responses to critical slide and for the experimental group (*N* = 33) and the control group (*N* = 33); (error bars represent standard error of the proportion)", include=FALSE}
