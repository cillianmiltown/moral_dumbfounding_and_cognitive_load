...
```{r ch5S5fig2criticalcondition, fig.cap="Study S5: Responses to critical slide and for the experimental group (*N* = 98) and the control group (*N* = 106)", include=TRUE}
