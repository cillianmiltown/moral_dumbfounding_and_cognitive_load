...
source("~/Dropbox/College/research/Research_general/cog_load/moral_dumbfounding_and_cognitive_load/load_all_data_UK.R")
rm(list = ls())

load("loaded_data/six_UK.RData")
df3 <- study_6
#df3$InCS
